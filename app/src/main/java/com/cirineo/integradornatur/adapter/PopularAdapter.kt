package com.cirineo.integradornatur.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.cirineo.integradornatur.databinding.PopulerItemBinding
...
val item = items[position]
    ...
    class PouplerViewHolder (private val binding: PopulerItemBinding) : RecyclerView.ViewHolder(binding.root){
        ...
        fun bind(item: String,price: String, images: Int) {
            binding.productoNamePopular.text = item
            binding.PrecioPopular.text = price
